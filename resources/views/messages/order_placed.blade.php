    ...
    <div class="message-page-wrapper">
      <div class="row">
        <div class="col-md-12">
          ...
          <h4 class="d-message">Your Order Successfully Placed.</h4>
          <hr style="float:left;width:100%;">
          <h3 class="message-heading"> Order Detail Below </h3>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 table-outter">
          ...
          <div class="row">
           	<div class="col-md-2 col-sm-3 col-xs-5">
           	  <b>Tracking Id or Booking Ref.</b>
           	</div>
           	<div class="col-md-10 col-sm-9 col-xs-7">
           	  SK-BKI-0{{ $data['TrackingId'] }}
           	</div>
          </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <small>
            Thank you for Shopping, We also have been mailed, Your order detail with Tracking Id or Booking Ref. at <b>{{ $data['ToEmail'] }}</b>. Please check your mail.
          </small>
        </div>
      </div>
    </div>
